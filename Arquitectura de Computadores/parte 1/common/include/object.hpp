...
struct Hit final {
    ...
    const material* mat{nullptr};  // Material en el punto (no propiedad)
    ...
    void set_face_normal(const ray& r, const vector& outward_normal) noexcept {
...
public:
    ...
    [[nodiscard]] virtual hit_opt intersect(const ray& r,
                                            double t_min,
